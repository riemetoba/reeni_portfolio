  ...
  return (
    <section className="bg-white dark:bg-bg-dark-main transition-colors duration-300">
      <div className="container lg:py-20 py-10 px-5 lg:px-0">
        ...
        <p className="text-base text-[#5D6570] dark:text-[#A3AED0] font-rubik text-center lg:w-156.75 w-full mx-auto lg:mt-0 mt-1.25">
        ...
        <div className="lg:flex justify-between items-center lg:mt-15 mt-7.5">
          <div className="lg:w-1/2 w-full">
            <div className="">
              <div className="py-8.5 px-9.5 bg-[#f4f4f4] dark:bg-[#141414] rounded-[20px] border-b-3 border-r-3 border-red dark:border-none transition-colors duration-300">
                <h2 className="text-2xl text-common dark:text-white font-bold font-rajdhani leading-15">
                  01. A Portfolio of Creativity
                </h2>
                <p className="text-base text-[#5D6570] dark:text-[#A3AED0] font-rubik leading-6.5 mt-1">
